...
export default function AboutMe() {
    return (
        ...
        <div className="about-me">
            <h1 style={{position: 'relative', top: -10}}>About Me</h1>
        </div>
                    ...
                    <div className="card-content-flex">
                        ...
                        <Card.Content >
                            ...
                            <Card.Description>
                                ...
                                When I'm not coding, I enjoy reading, exercising, spending time outside, and enjoying life with my friends and family. In addition to my passion for technology, I am also a licensed wedding officiant and have performed several weddings for friends and family.<br/><br/>
